> Historical snapshot: the report below describes the earlier private capture. Its selected-run fields, costs, source revisions and publication statements are historical. The [current report](https://github.com/reproducible-ai/notes/blob/main/023-robotics-gr00t/README.md) describes the selected public run.

# GR00T N1.7

Historical operator recorded in the original row: `training-operator:c264c8b2-05fa-4997-a6c5-e0f755db4607`, configured model `gpt-6-astra`, harness `reproducible-ai-harness` version `0.1.0`. This identity belongs to the private capture only.
...
See [costs](https://github.com/reproducible-ai/notes/blob/main/023-robotics-gr00t/costs.md) for individual jobs, unknown charges and timing sources.
...
[Capture summary](https://github.com/reproducible-ai/notes/blob/main/023-robotics-gr00t/evidence/capture-summary.json) records source revisions, receipt hashes and supporting-file availability.
See [commands](https://github.com/reproducible-ai/notes/blob/main/023-robotics-gr00t/commands.md) and [issues](https://github.com/reproducible-ai/notes/blob/main/023-robotics-gr00t/issues.md).
...
See the [fresh public canary](https://github.com/reproducible-ai/notes/blob/main/023-robotics-gr00t/PUBLIC-RELEASE.md) for verified downloads and public GLaaS lineage.
